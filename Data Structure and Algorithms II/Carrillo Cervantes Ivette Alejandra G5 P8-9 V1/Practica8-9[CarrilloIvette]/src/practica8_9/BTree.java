...
public class BTree {
    ...
    public static BTree crearArbol(){
        Scanner sc = new Scanner(System.in);
        System.out.print("¿De qué orden es tu árbol? ");
        int orden = sc.nextInt();
        BTree arbol = new BTree(orden);
        
        System.out.print("¿Cuantos nodos quieres crear? ");
        int nodos = sc.nextInt();
        
        for (int i = 0; i < nodos; i++) {
            System.out.print("Ingresa el valor del nodo "+i+": ");
